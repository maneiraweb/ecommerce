                            ...
                            <div class="col-md-4">
                                <div class="shipping">
                                    ...
                                    <div class="shipping-form">
                                        <label class="cep">Informe seu CEP </label>
                                        <div class="input-box">
                               ...
                               <div class="discount">
                                ...
                                <div class="discount-form">
                                    <label for="coupon_code">Informe aqui seu cupom promocional.</label>
                                    <input name="remove" id="remove-coupone" value="0" type="hidden">
                                    <div class="input-box">
                                        <input type="text" placeholder="" value="" id="cep" class="input-text" name="Cupom">
                                        <input type="submit" formmethod="post" formaction="" value="Usar Cupom" class="button">
                                    </div>
                                </div>
                            </div>
                        </div>

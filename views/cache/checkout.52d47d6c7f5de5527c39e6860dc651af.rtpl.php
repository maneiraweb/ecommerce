<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="page-head">
	<h1>
	<div id="onestepcheckout-title">
    	<p id="onestepcheckout-title-description">Por favor, informe seus dados abaixo para concluir a compra.</p>
	</div>
</h1>
</div>
...
<div class="row">
    <div class="col-md-4">
        <div class="step" id="step1">
            ...
            <div class="title">
                <p id="onestepcheckout-title-description">Email Address</p>
            </div>
            <div class="modify">
        ...
        <div class="step" id="step2">
            ...
            <div class="title">
                <p id="onestepcheckout-title-description">INFORMAÇÕES PESSOAIS</p>
            </div>
        </div>
        <div class="content" id="address">
            <form class="go-right">
                ...
                <div>
                    <input type="name" name="last_name" value="" id="last_name" placeholder="Last Name" data-trigger="change" data-validation-minlength="1" data-type="name" data-required="true" data-error-message="Enter Your Last Name" />
    ...
    <div class="col-md-4">
        <div class="step" id="step3">
            ...
            <div class="title">
                <p id="onestepcheckout-title-description">Shipping Information</p>
            </div>
            <div class="modify">
                <i class="fa fa-plus-circle"></i>
            </div>
        ...
        <div class="content" id="shipping">
            <form action="" method="" name="">
                ...
                <p>
                    <input type="radio" id="shipping_2" value="2" />
                    <label for="shipping_2"> Express Shipping <span class="price">$8.00</span></label>
                </p>
                <p>
                    <input type="radio" id="shipping_3" value="3" />
        ...
        <div class="step" id="step4">
            ...
            <div class="title">
                <p id="onestepcheckout-title-description">Payment Information</p>
            </div>
            <div class="modify">
                <i class="fa fa-plus-circle"></i>
            </div>
    ...
    <div class="col-md-4">
        <div class="step" id="step5">
            ...
            <div class="title">
                <p id="onestepcheckout-title-description">Finalize Order</p>
            </div>
            <div class="modify">
                <i class="fa fa-plus-circle"></i>
            </div>
